export const DSA = {
  stack:
    "Linear DataStructure that follows LIFO order for any insertion/deletion operation",

  Queue:
    "Linear DataStructure that follows FIFO order for any insertion/deletion operation",
