...
const QueueViewer = (props: IQueueViewProps) => {
  const { queue, maxSize } = props;

  return (
    <div className="border-1 border-white/90 rounded-md w-[400px] m-auto h-[130px] p-2">
      ...
      {/* Size + Max Size */}
      <div className="flex flex-row gap-6 justify-center items-center text-[var(--primary-color)]/50 mt-4">
        <Text size="14px" weight="500" content={`Size: ${queue.length}`} />
